...
const toggleSidebar = () => {
  ...
  return (
    <>
    <section className="flex gap-6 fixed top-[70px] sm:top-[88px] md:top-[88px] lg:top-[88px] left-0 bottom-0 z-50 border-r border-gray-700">
      <div
