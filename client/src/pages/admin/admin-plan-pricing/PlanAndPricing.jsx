            ...
            <div className="text-white py-10 px-4">
              <div className="px-4">
                <div className="flex mb-8 justify-end">
                  <button
                    onClick={onOpenModal}
                    className="py-3 w-36 flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-purple-600 text-slate-950 hover:bg-purple-700 disabled:opacity-50 disabled:pointer-events-none"
                  >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                  {plans.map((plan) => (
                    <div
                      ...
                      key={plan.id}
                      className="relative bg-slate-900 p-6 rounded-lg border border-b-2 border-gray-700 shadow-sm shadow-gray-500 transition-shadow duration-300 hover:-translate-y-1"
                    >
                      <div className="flex items-baseline mb-6 justify-between gap-10">
