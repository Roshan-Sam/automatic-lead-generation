...
const Profile = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await axios.put(
        `${config.baseApiUrl}admin/update-profile/${profile.id}/`,
        formDataToSubmit,
        {
          headers: {
  ...
  const handlePasswordSubmit = async (e) => {
    ...
    try {
      const res = await axios.put(
        `${config.baseApiUrl}admin/update-password/${profile.id}/`,
        passwordFormData
      );
      if (res.status === 200) {
            ...
            <div className="flex pt-10 px-4 mb-12">
              <ul className="bg-slate-900 border border-gray-700 rounded-full py-2 px-4 -space-x-4 w-max flex items-center mt-4">
                ...
                <li className="bg-purple-600 text-white underline rounded-r-full z-10 px-8 py-3 text-base cursor-pointer">
                  <Link to="/admin/account">Profile</Link>
                </li>
              </ul>
            </div>
            <div className="px-4">
                  ...
                  <div className="order-1 lg:order-2 bg-slate-900 p-6 rounded-lg shadow-sm border border-gray-700">
                    ...
                    <div className="flex flex-col items-center">
                      <img
                        ...
                        src={
                          profileImage
                            ...
                            : `${config.baseApiImageUrl}${profile.profile}`
                        }
                      ...
                      <div className="mt-4">
                        ...
                        >
                          <MdEdit className="inline-block mr-2" /> Edit your
                          photo
                        </label>
                        <input
                          type="file"
