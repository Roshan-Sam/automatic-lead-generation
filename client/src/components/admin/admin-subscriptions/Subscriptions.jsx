  ...
  const handleStatusChange = async (id, newStatus) => {
    try {
      const response = await axios.patch(
        `${import.meta.env.VITE_API_URL}admin/subscriptions/${id}/update/`,
        { status: newStatus }
      );
  ...
  const confirmDelete = async () => {
    try {
      const response = await axios.delete(
        ...
        }admin/subscriptions/${deleteCompanySubscriptionId}/delete/`
      );
      if (response.status === 200) {
                  ...
                  <div className="flex flex-col gap-4">
                    ...
                    <div className="flex gap-2">
                      <div className="relative w-48 h-fit border border-gray-700 rounded-lg outline-none dropdown-one">
                        <button
                          onClick={showDropDownMenuOne_form_layout_wizard9}
                        ...
                        >
                          <div className="relative">
                            <button
                              ...
                              onClick={() => toggleDropdown1(subscription.id)}
                            >
                          ...
                          >
                            {subScriptionPlans.map((subscription, id) => (
                              <a key={id}>
                                <p
                                  className="p-3 text-sm leading-none text-gray-600 cursor-pointer hover:bg-indigo-100 hover:font-medium hover:text-indigo-700 hover:rounded"
                                  onClick={swaptextone_form_layout_wizard5}
                                >
                          ...
                          >
                            {periodOptions.map((period, index) => (
                              <a key={index}>
                                <p
                                  className="p-3 text-sm leading-none text-gray-600 cursor-pointer hover:bg-indigo-100 hover:font-medium hover:text-indigo-700 hover:rounded"
                                  onClick={swaptextone_form_layout_wizard6}
                                >
                                  {period}
                                </p>
                              </a>
                  ...
                  <div>
                    <div className="flex flex-col">
                      ...
                      <div className="mt-4">
                        ...
                        <div className="relative h-fit border border-gray-700 rounded-lg outline-none dropdown-one">
                          <button
                            onClick={showDropDownMenuOne_form_layout_wizard7}
                            className="relative flex items-center justify-between w-full p-2.5 focus:border-purple-600 focus:ring-2 focus:ring-purple-600 rounded-lg"
                          >
                            <span
                              className="pr-4 text-sm text-white"
                          ...
                          >
                            {subScriptionPlans.map((subscription, id) => (
                              <a key={id}>
                                <p
                                  className="p-3 text-sm leading-none text-gray-600 cursor-pointer hover:bg-indigo-100 hover:font-medium hover:text-indigo-700 hover:rounded"
                                  onClick={swaptextone_form_layout_wizard7}
                                >
                                  {subscription.plan_name}
                                </p>
                              </a>
                      ...
                      <div className="mt-4">
                        ...
                        <div className="relative h-fit border border-gray-700 rounded-lg outline-none dropdown-one">
                          <button
                            onClick={showDropDownMenuOne_form_layout_wizard8}
                            className="relative flex items-center justify-between w-full p-2.5 focus:border-purple-600 focus:ring-2 focus:ring-purple-600 rounded-lg"
                          >
                            <span
                              className="pr-4 text-sm text-white"
                          ...
                          >
                            {periodOptions.map((period, index) => (
                              <a key={index}>
                                <p
                                  className="p-3 text-sm leading-none text-gray-600 cursor-pointer hover:bg-indigo-100 hover:font-medium hover:text-indigo-700 hover:rounded"
                                  onClick={swaptextone_form_layout_wizard8}
                                >
                                  {period}
                                </p>
                              </a>
